...
open class HybridNativeLoggerSpec_cxx {
  /**
   * The Swift <> C++ bridge's namespace (`margelo::nitro::logger::bridge::swift`)
   ...
   */
  @inline(__always)
  public func equals(other: HybridNativeLoggerSpec_cxx) -> Bool {
  ...
  // Methods
  @inline(__always)
  public final func enqueue(entries: bridge.std__vector_NativeLogEntry_) -> bridge.Result_void_ {
    do {
      try self.__implementation.enqueue(entries: entries.map({ __item in __item }))
