...
namespace margelo::nitro::refresh {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/refresh/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/refresh/Func_void_cxx;";
