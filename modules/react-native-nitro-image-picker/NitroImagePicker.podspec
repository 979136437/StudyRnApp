...
Pod::Spec.new do |s|
  ...
  s.frameworks   = ['AVFoundation', 'Photos', 'PhotosUI', 'UIKit', 'UniformTypeIdentifiers']

  load 'nitrogen/generated/ios/NitroImagePicker+autolinking.rb'
