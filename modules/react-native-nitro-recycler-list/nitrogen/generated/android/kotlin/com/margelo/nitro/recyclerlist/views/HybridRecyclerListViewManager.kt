///
/// HybridRecyclerListViewManager.kt
...
/**
 * Represents the React Native `ViewManager` for the "RecyclerListView" Nitro HybridView.
 */
public class HybridRecyclerListViewManager: SimpleViewManager<View>() {
  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridRecyclerListView::class.java)) {
  ...
  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = HybridRecyclerListView(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridRecyclerListViewStateUpdater.updateViewProps(hybridView, stateWrapper)
  ...
  private fun getHybridView(view: View): HybridRecyclerListView? {
    return view.getTag(associated_hybrid_view_tag) as? HybridRecyclerListView
  }
}
