...
namespace margelo::nitro::recyclerlist {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/recyclerlist/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/recyclerlist/Func_void_cxx;";
