///
/// HybridPickerViewManager.kt
/// This file was generated by nitrogen. DO NOT MODIFY THIS FILE.
/// https://github.com/mrousavy/nitro
/// Copyright © Marc Rousavy @ Margelo
///

package com.margelo.nitro.pickerview.views
...
import com.margelo.nitro.pickerview.*

/**
 * Represents the React Native `ViewManager` for the "PickerView" Nitro HybridView.
 */
public class HybridPickerViewManager: SimpleViewManager<View>() {
  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridPickerView::class.java)) {
  ...
  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = HybridPickerView(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridPickerViewStateUpdater.updateViewProps(hybridView, stateWrapper)
  ...
  private fun getHybridView(view: View): HybridPickerView? {
    return view.getTag(associated_hybrid_view_tag) as? HybridPickerView
  }
}
