...
namespace margelo::nitro::compressor {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "ThumbnailResult" and the Kotlin data class "ThumbnailResult".
   */
  struct JThumbnailResult final: public jni::JavaClass<JThumbnailResult> {
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/compressor/ThumbnailResult;";
