...
namespace margelo::nitro::compressor {
  ...
  /**
   * A struct which can be represented as a JavaScript object (CompressionResult).
   */
  ...
  public:
    ...
    explicit CompressionResult(std::string path, double size, double width, double height, double duration, double fps, double bitrate): path(path), size(size), width(width), height(height), duration(duration), fps(fps), bitrate(bitrate) {}

  public:
    friend bool operator==(const CompressionResult& lhs, const CompressionResult& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ CompressionResult <> JS CompressionResult (object)
  template <>
  struct JSIConverter<margelo::nitro::compressor::CompressionResult> final {
    static inline margelo::nitro::compressor::CompressionResult fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::compressor::CompressionResult(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::compressor::CompressionResult& arg) {
