...
namespace margelo::nitro::compressor {
  ...
  public:
    ...
    explicit ThumbnailResult(std::string path, double size, double width, double height): path(path), size(size), width(width), height(height) {}
...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::compressor::ThumbnailResult> final {
    static inline margelo::nitro::compressor::ThumbnailResult fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::compressor::ThumbnailResult(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::compressor::ThumbnailResult& arg) {
